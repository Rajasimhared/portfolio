...
Array(100)
  .fill()
  .map(() => createMeshRandomAndRotate(crystalGeometry, whiteBasicMaterial));
Array(100)
  .fill()
  .map(() => createMeshRandomAndRotate(sphereGeometry, whiteBasicMaterial));
Array(100)
  .fill()
  .map(() => createMeshRandomAndRotate(torusGeometry, whiteBasicMaterial));
...
const animate = () => {
  ...
  camera.lookAt(
    floatingIsland ? floatingIsland.position : new THREE.Vector3(0, 0, 0)
  );
