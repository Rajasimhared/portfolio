const projects = [{
        id: 'tryouts',
        name: 'Tryouts',
        description: 'Web based chat application that has features like login, signup with profile pic, search friends, create chat, create a group chat, remove members from group chat',
    ...
    },
    {
        id: "online-editor",
        name: 'Online Editor',
        description: 'Custom documents manager which allows to create, edit documents by uploading pdf template and download the final draft in docx or pdf format.<br>This was developed for a specific requirement as part of our freelance work',
    ...
    },
    {
        ...
        description: 'While exploring unity 3D I have build this simple game that involves different geometries, textures, laws of physics. <br>Build in the unity application was ported to web using the webGL renderer.',
        githubLink: '',
...
const experiences = [{
    ...
    <ul>
        ...
        <li>
            Created custom web components from <strong>scratch</strong> which
            were later used
            across many projects, as there were no OOTB components for the
            designs.
        </li>
        <li>
            Active member of <strong>POC</strong> team
        </li>
